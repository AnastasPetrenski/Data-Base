    ...
    public class ProductShopProfile : Profile
    {
        public ProductShopProfile()
        {
            ...
            this.CreateMap<JToken, UserInfo>()
                .ForMember(x => x.FirstName, y => y.MapFrom(j => j.SelectToken(".firstName").Value<string>() ?? null))
                .ForMember(x => x.LastName, y => y.MapFrom(j => j.SelectToken(".lastName").Value<string>() ?? null))
