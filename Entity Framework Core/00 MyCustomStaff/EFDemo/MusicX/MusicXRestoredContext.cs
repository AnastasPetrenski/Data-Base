...
namespace EFDemo.MusicX
{
    public partial class MusicXRestoredContext : DbContext
    {
        public MusicXRestoredContext()
        {
        }

        public MusicXRestoredContext(DbContextOptions<MusicXRestoredContext> options)
            : base(options)
        {
        }
